...
pliki do toru to (tor4_prosty.png oraz znaki do tego toru: skręt_w_lewo_c_42.png, skręt_w_prawo_c_2.png, skręt_w_prawo_c_22.png)

project.tm to plik z gotowymi zdjęciami do strony teachablemachine można go dodać po prze kliknięcie opcji oraz Otwórz projekt z pliku.
